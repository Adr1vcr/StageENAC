...
def cxi_druot(cz, width, span, aspect_ratio):
    """
...
def cxi_basic_model(cz, aspect_ratio):
    """
trouvé sur internet
    :param aspect_ratio:
    :param cz:
...
def cxi_model_1(cz, width, span, aspect_ratio):
...
def cxi_model_2(cz, aspect_ratio, sweep):
    if sweep <= 30:
...
def cxi_model_3(cz, mach, aspect_ratio, sweep):
